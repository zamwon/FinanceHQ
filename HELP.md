...
* The original package name 'com.example.finance-hq' is invalid and this project uses 'com.example.finance_hq' instead.
...
- Backend-only dev: `./mvnw spring-boot:run` from the repo root.
